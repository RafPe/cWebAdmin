...
Update-xDscResource -Name RafPe_cWebAppPoolDefaults -FriendlyName cWebAppPoolDefaults -ModuleName cWebAdmin -Property $autoStart  -Verbose    

Update-xDscResource -Name RafPe_cWebAppPoolDefaults -Property $xDscProperties -FriendlyName cWebAppPoolDefaults -ClassVersion '1.0' -Verbose -Force